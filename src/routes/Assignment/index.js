...
const GetAllSubmitions = require('../../api/Assignment/GetAllSubmitions')
const Mark = require('../../api/Assignment/Mark')
...
router.get('/allsuubmitedassignment',verifyToken,GetAllSubmitions)
router.post('/mark',verifyToken,Mark)
